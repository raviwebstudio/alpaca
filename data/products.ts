...
export const products: Product[] = [
  createProduct({
    ...
    images: [
      createImage(
        ...
        "Motion Heavy Tee front editorial view",
      ),
      createImage(
        "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=1400&q=80",
        "Motion Heavy Tee lifestyle side profile",
      ),
      createImage(
        "https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&w=1400&q=80",
        "Motion Heavy Tee styled with city layers",
      ),
    ],
  ...
  createProduct({
    ...
    category: "basics",
    sizes: ["S", "M", "L"],
    colors: [createColor("Black", "#000000"), createColor("Porcelain", "#F8F5F2")],
    images: [
      createImage(
        "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?auto=format&fit=crop&w=1400&q=80",
        "Core Rib Tank editorial front view",
      ),
      createImage(
        "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=1400&q=80",
        "Core Rib Tank styled under a light layer",
      ),
    ],
